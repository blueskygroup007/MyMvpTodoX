...
import com.bluesky.rabbit_habit.habit_list.HabitFragment.OnListFragmentInteractionListener;
...
public class MyHabitRecyclerViewAdapter extends RecyclerView.Adapter<MyHabitRecyclerViewAdapter.ViewHolder> {
    ...
    //todo 需要重写adapter,item的xml布局文件
    private final List<DummyItem> mValues;
    private final OnListFragmentInteractionListener mListener;

    public MyHabitRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
